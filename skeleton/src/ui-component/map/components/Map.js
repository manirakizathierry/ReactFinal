...
import { MAPBOX_API_KEY, MAP_DEFAULT_OPTIONS, MAP_INITIAL_VIEWSTATE, MAP_STYLES } from '../constants';
...
const Map = ({ classes }) => {
    ...
    const setStateOfMapOptions = (options) => {
        setMapOptions({
            ...mapOptions,
            ...options
        });
    ...
    return (
        <div className={classes.geoContainer}>
            <MapControlsContainer>
                <MapStyleControl name="Map style" setMapOptions={(options) => setStateOfMapOptions(options)} />
            </MapControlsContainer>
